...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.tab.addTab(self.tab_widget_2, 'Modulated (freq)')
        ...
        self.tab.addTab(self.tab_widget_4, 'Demodulated (freq)')
        ...
        self.tab_layout_3.addWidget(self._qtgui_time_sink_x_0_1_win)
        ...
        self.dc_blocker_xx_0 = filter.dc_blocker_ff(5000, True)
        ...
        self.analog_sig_source_x_0_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 1100, 0.5, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 11000, 0.5, 0, 0)
        self.analog_phase_modulator_fc_0 = analog.phase_modulator_fc((2*22*75000/7))
        ...
        self.connect((self.dc_blocker_xx_0, 0), (self.qtgui_time_sink_x_0_1, 0))
